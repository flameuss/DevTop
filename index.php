...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-secondary" style="">
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar12">
      ...
      <div class="collapse navbar-collapse" id="navbar12"> <a class="navbar-brand d-none d-md-block" href="index.php">
        ...
        <ul class="navbar-nav">
          <li class="nav-item text-white">
            <a class="nav-link text-white" href="/sites/devtop/painel.php">Log in</a>
          </li>
  ...
  <div class="py-5 px-3 pl-5" style="">
    <div class="container">
      <div class="row">
  ...
  <div class="py-5" style="">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 order-2 order-lg-1 p-0"> <img class="img-fluid d-block border rounded-lg shadow border-secondary" src="./img/01.jpg" style=""> </div>
        <div class="px-5 col-lg-6 d-flex flex-column align-items-start justify-content-center order-1 order-lg-2">
          <h1>Plataforma de cursos para todos!</h1>
          <p class="mb-3">A DevTop vem para auxiliar tanto programadores iniciantes, avançados ou experts como também os que tem curiosidades sobre o que é programação.<br> Assim abrindo a porta para todas as pessoas aprenderem e desbravar o universo da programação.
          </p>
          <form class="form-inline d-flex justify-content-center mb-4">
            <div class="input-group">
              <div class="input-group-append"> <button class="btn btn-lg text-light btn-secondary" type="button">Subscribe</button> </div>
            </div>
          </form>
        </div>
      </div>
