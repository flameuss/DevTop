...
<body>
  ...
  <div class="py-5 text-center" style="background-image:none">
    <div class=">
    <div class=" container">
      <div class="row" style="">
        <div class="mx-auto col-md-6 col-10 bg-white p-5" style="">
          <h1 class="mb-4 text-secondary"><b>Login</b></h1>

          <form action="login.php" method="POST">
            <div class="form-group">
              <input type="login" name="login" class="form-control rounded-p" id="form9" required="required" style="" placeholder="Login">
            </div>
            <div class="form-group mb-3">
              <input type="password" name="password" class="form-control rounded-p" id="form10" required="required" placeholder="Password">
              <small class="form-text text-muted text-right">
                <a href="#" class="text-secondary">Esqueceu a senha?<br></a>
              </small>
            </div> <button type="submit" class="btn text-white btn-secondary">Entrar</button><a class="btn text-white mx-2" href="#" style="background:#dd4b39" target="_blank"><i class="fa fa-google-plus fa-fw fa-1x py-1"></i></a>
          </form>
        </div>
      </div>
    </div>
